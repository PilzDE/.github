...
- Acceptance criteria are defined (see point 7 from [dzone.com](https://dzone.com/articles/10-tips-for-writing-good-user-stories))
  - The conditions that have to be fulfilled such that the story is done are described. The description should allow **any member** of the dev team to decide whether the story is done without further communication with PO or stakeholders.
